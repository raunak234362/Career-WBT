...
const Contest = () => {
  ...
  return (
    <div className="flex flex-col item-center bg-white p-5">
      <div className="flex flex-col justify-center bg-white rounded-lg w-[30%] shadow-lg p-5">
        ...
        <CgAdd className="flex justify-center text-2xl text-black"/>
          ...
          <div className='overflow-y-auto mt-8 h-80 table-container'>
        <table className='w-full table-auto border-collapse text-center'>
          <thead>
            <tr className='bg-gray-200'>
              ...
              <th className='px-2 py-2'>Show Questions</th>
            </tr>
          </thead>
          <tbody></tbody>
        </table>
